...
DISCOURSE_NOTIFICATION_EMAIL="${DISCOURSE_NOTIFICATION_EMAIL:-noreply@noema-audioverse.com}"
...
sed \
  ...
  -e "s|__DISCOURSE_NOTIFICATION_EMAIL__|${DISCOURSE_NOTIFICATION_EMAIL}|g" \
